...
There are 192,687 sars-cov-2 papers.
...
Among all the article, there are 53 article that do not have abstract. 
...
Among all the article, there is 0 article that have no title.
